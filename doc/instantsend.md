...
This mechanism has been integrated into Bitcore-Node-Esmacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/esmacoincoin/insight-api-esmacoin#web-socket-api](https://github.com/esmacoincoin/insight-api-esmacoin#web-socket-api) 
* API: [https://github.com/esmacoincoin/insight-api-esmacoin#instantsend-transactions](https://github.com/esmacoincoin/insight-api-esmacoin#instantsend-transactions) 
...
By default, the Esmacoin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Esmacoin daemon:
