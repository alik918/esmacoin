...
Only requiring some minor changes is esmacoin.cpp.
...
Changes to esmacoin.cpp
----------------------
esmacoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
