...
Esmacoin is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Esmacoin, where everyone uses
...
pay attention to for reviewers of Esmacoin code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Esmacoin uses tinyformat, which is type safe. Leave them out to avoid confusion
