...
{
    if(fLiteMode) return; // ignore all Esmacoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Esmacoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("esmacoin-privatesend");
