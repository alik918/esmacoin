...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EsmacoinNetwork") type = EsmacoinNetwork;
    if(strType == "EsmacoinNetworkVariable") type = EsmacoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EsmacoinNetwork) s = "EsmacoinNetwork";
    if(type == EsmacoinNetworkVariable) s = "EsmacoinNetworkVariable";
