    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Esmacoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Esmacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and esmacoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Esmacoin"), this);
    aboutAction->setStatusTip(tr("Show information about Esmacoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Esmacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Esmacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Esmacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a esmacoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Esmacoin help message to get a list with possible Esmacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Esmacoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Esmacoin network", "", count));
}
...
{
    QString strTitle = tr("Esmacoin"); // default title
