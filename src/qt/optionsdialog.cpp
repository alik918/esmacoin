    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ESMA-light"), QVariant("light"));
    ui->theme->addItem(QString("ESMA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ESMA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ESMA-traditional"), QVariant("trad"));
