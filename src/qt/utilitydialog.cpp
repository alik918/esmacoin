    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Esmacoin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Esmacoin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  esmacoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Esmacoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ESMA, 0.1 ESMA, 1 ESMA and 10 ESMA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://esmacoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://esmacoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Esmacoin is shutting down...") + "<br /><br />" +
