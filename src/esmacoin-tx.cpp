...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Esmacoin esmacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  esmacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded esmacoin transaction") + "\n" +
              "  esmacoin-tx [options] -create [commands]   " + _("Create hex-encoded esmacoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded esmacoin transaction
