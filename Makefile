...
pkgdatadir = $(datadir)/esmacoin
pkgincludedir = $(includedir)/esmacoin
pkglibdir = $(libdir)/esmacoin
pkglibexecdir = $(libexecdir)/esmacoin
...
CONFIG_HEADER = $(top_builddir)/src/config/esmacoin-config.h
...
ACLOCAL = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = esmacoin
PACKAGE_BUGREPORT = https://github.com/esmacoin-coin/esmacoin-source/issues
PACKAGE_NAME = Esmacoin
PACKAGE_STRING = Esmacoin 1.6.3
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/mar/EsmaCore_1.6.3
abs_srcdir = /home/mar/EsmaCore_1.6.3
abs_top_builddir = /home/mar/EsmaCore_1.6.3
abs_top_srcdir = /home/mar/EsmaCore_1.6.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mar/EsmaCore_1.6.3/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/esmacoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/esmacoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/esmacoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Esmacoin-Qt.app
OSX_VOLNAME = Esmacoin
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_esmacoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_esmacoin_coverage.info test_esmacoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Esmacoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/esmacoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/esmacoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/esmacoin-config.h
$(top_srcdir)/src/config/esmacoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/esmacoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Esmacoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Esmacoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Esmacoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_esmacoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_esmacoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_esmacoin_filtered.info: test_esmacoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_esmacoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_esmacoin_filtered.info
...
#test_esmacoin_coverage.info: baseline_filtered_combined.info test_esmacoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_esmacoin_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_esmacoin_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_esmacoin_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_esmacoin.coverage/.dirstamp:  test_esmacoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_esmacoin.coverage/.dirstamp total.coverage/.dirstamp

# Esmacoin: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_esmacoin.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
